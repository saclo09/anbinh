       ...
       <asp:Repeater ID="Repeater1" runat="server" >
        <ItemTemplate>
                    <div  id="<%#"sticky"+Eval("IdProduct").ToString()%>"  class="atip" >
                        <div class="tieudeboxshow2"><center> Nội dung sản phẩm </center></div>
                         ...
                         <img alt='' src='/Images/Lixanh.png' height='15' width='15' />Mã sản phẩm: <asp:Label ID="lblMasp" Font-Bold="true" runat="server" Text='<%# Eval("IDNameProduct") %>'></asp:Label><br />
                         <img alt='' src='/Images/Lixanh.png' height='15' width='15' />Kích thước: <asp:Label ID="lblMausac" Font-Bold="true" runat="server" Text='<%# Eval("Color") %>'></asp:Label><br />
                         <img alt='' src='/Images/Lixanh.png' height='15' width='15' />Đơn vị tính: <asp:Label ID="Label2" Font-Bold="true" runat="server" Text='<%# Eval("Material") %>'></asp:Label><br />
                         <img alt='' src='/Images/Lixanh.png' height='15' width='15' />Xuất xứ: <asp:Label ID="lblXuatxu" Font-Bold="true" runat="server" Text='<%# (int.Parse(Eval("Manufacturer").ToString())>0)?  ManufacturerBLL.getManufacturerBYId((int)Eval("Manufacturer")).ManufacturerName :"" %>'></asp:Label><br />
                         <img alt='' src='/Images/Lixanh.png' height='15' width='15' />Tình trạng: <asp:Label ID="lblTinhtrag" Font-Bold="true" runat="server" Text='<%# (int.Parse(Eval("Soluong").ToString())>0)?"Còn hàng":"Hết hàng" %>'></asp:Label><br />
                         <img alt='' src='/Images/Lixanh.png' height='15' width='15' />Khuyến mãi: <asp:Label ID="Label3" Font-Bold="true" runat="server" Text='<%# (bool.Parse(Eval("IsGiamGiaPt").ToString())==true)? "Đang khuyến mãi":"Không" %>'></asp:Label><br />
