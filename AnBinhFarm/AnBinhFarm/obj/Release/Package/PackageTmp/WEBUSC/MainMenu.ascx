                    ...
                    <asp:Repeater ID="rptMenu" runat="server" OnItemDataBound="ItemBound" > 
                        ...
                        <ItemTemplate >
                             <li class="dropdown">
                                ...
                                <a <%#(bool)Eval("HasChild")?"class='dropdown-toggle' data-toggle='dropdown'":"" %>   href="<%#Eval("LinkString") %>"><%# Eval("Name") %> <%#(bool)Eval("HasChild")?"<span class='caret'></span>":"" %></a>
                                 ...
                                 <asp:Repeater ID="ChildRepeater" runat="server"  > 
                                    ...
                                    <ItemTemplate >
                                         <li>
                                            <a  href="<%#Eval("LinkString") %>"><%# Eval("Name") %></a>
                                             </li>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        </ul>
