...
<asp:Repeater ID="dsSP" runat="server" > 
    <ItemTemplate >
          <div class="khungsp" data-tooltip="<%#"sticky"+Eval("IdProduct").ToString()+"111"%>">
 ...
 <div id='harveststickytooltip' class='stickytooltip'>
       <asp:Repeater ID="rptProductDetail" runat="server"  OnItemDataBound="rptProductDetail_ItemDataBound" >
        <ItemTemplate>
                    <div  id="<%#"sticky"+Eval("IdProduct").ToString()+"111"%>"  class="atip" >
                        <div class="tieudeboxshow2"><center> Nội dung sản phẩm </center></div>
                         <div class="ndboxshow2">                     
                         <span class="text-center"><asp:Label ID="lblTen" ForeColor="Blue" Font-Bold="true" runat="server" Text='<%# Eval("NameProduct") %>'></asp:Label></span>
